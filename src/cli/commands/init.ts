...
export interface InitOptions {
  ...
  yes?: boolean;
  /** Disable security scan (security scan runs by default) */
  noSecure?: boolean;
}
...
This file is created by LogicStamp Context. Customize it to fit your project's needs.
`;
  ...
  if (shouldRunSecurity) {
    ...
    console.log('\nNext steps:');
    console.log('  • Run `stamp context` to compile context files');
